...
class KlasemenModel extends CI_Model
{
    ...
    {
        $club1_data = $this->db->get_where('klasemen', array('id' => $club1_id))->row_array();
        $club2_data = $this->db->get_where('klasemen', array('id' => $club2_id))->row_array();
