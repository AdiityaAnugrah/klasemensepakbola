...
<body>
    <div class="container">
        ...
        <form action="<?= base_url('KlasemenController/process_input_score') ?>" method="post">
        ...
        <div class="btn-back">
            <a href="<?= base_url('KlasemenController/index') ?>" class="btn btn-secondary btn-sm">Kembali ke
                Klasemen</a>
        </div>
    </div>
